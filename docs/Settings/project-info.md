---
title: Settings - Program Information and settings
hide:
  - toc
---

The program information can be read and changed within the Program **Settings** page of your programs.
...
You can read Program Basic Information and Budget details in the **Settings** Page.
...
## Update your basic Program information
...
![Update Program Information](../assets/img/ProjectInfoSettings.png)
...
In the **Basic Information** table, you can either enable the **Use of validation** (1) or **Use scope in the program** (2).
...
To do so, you’ll need to provide a list of branches or areas you want to include. This list will be integrated into your registration form to ensure that all data is correctly linked to the appropriate scope. Once configured, you’ll be able to assign scopes to individual users on the [program team page.](../team/add-team-members.md)
