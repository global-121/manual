...
The program budget and base transfer value can be set and changed within the Program **Settings** page of your programs.
...
In the second table **Budget**, you will find the budget and payment-related details for your program. During the program, you may need to adjust the budget, base transfer value, number of payments, or the program's currency. These settings can be modified at any time. **All changes made on the Budget page take effect immediately and apply to the entire registration list**.
