...
Unless you manually import registrations with an excel .CSV file, registrations done with KOBO will automatically be imported within your program in 121 Platform, in the **Registrations** page.

- Create your KOBO-form on the KOBO tool;
- Share this Kobo-form with our Kobo account (ask our support team);
