...
The Program metrics translates your program requirements and settings. The details provide the main information about the duration and location of your project, budget, targeted beneficiaries, cash aid delivery and distribution frequencies. Each of your active projects may have different metrics shown in the table below. These can be edited in the **Settings** page.
