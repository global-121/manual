...
- [Refuser un enregistrement d'un programme;](../registration/registration-reject-pa.md)
...
Suivez les instructions sur la [page de dédoublement](../registration/registration-deduplication.md)
