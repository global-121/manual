---
title: Enregistrements - Modifier les détails d'enregistrement
hide:
  - toc
---
...
### Prochaines étapes? Inclure les enregistrements dans un programme

Suivez les instructions pour [inclure les enregistrements directement dans le programme](./inclusion-in-program.md)
