---
title: Enregistrements - Refuser les enregistrements
hide:
  - toc
---

Tous les enregistrés pour votre programme ne peuvent pas être éligibles à être inclus dans le programme, ou il peut y avoir des cas d'enregistrements en double. Dans ces cas, vous devrez peut-être refuser des enregistrements du programme.

Vous utilisez la page **Enregistrements** pour choisir les prochaines actions appropriées: valider, refuser ou modifier les enregistrements.
...
Le **tableau d'enregistrements** vous montre tous les ménages ou individus enregistrés pour votre programme. Leur statut doit être **Nouveau**.
...
- En haut du tableau, cliquez sur le bouton **:fontawesome-solid-ban: Refuser**;
...
Pour activer les services de messagerie, vous devez créer un compte Twilio et vous assurer qu'il y a suffisamment de crédits de messagerie. Contactez notre équipe pour configurer cela.

Il y a une option pour envoyer un message aux enregistrements pour chaque action que vous effectuez sur la plateforme, telle que l'inclusion, le refus ou l'envoi de paiements aux enregistrements. Si vous souhaitez communiquer la progression du programme, vous pouvez cliquer sur le bouton **Envoyer un message aux enregistrements**.
