...
- Click to choose the CSV file from your computer that you have **already matched to the format required by 121**; ![Import Registration pop-up](../assets/img/ImportRegistrationTemplate.png)
