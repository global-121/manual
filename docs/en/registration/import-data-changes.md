...
The Import Data Changes function allows you to import or update registration information into the platform.
...
!!! warning "Phone numbers cannot be bulk updated"
    ...
    While it is possible to update phone numbers individually, it is not possible to bulk update phone numbers following the import data changes procedure. If you are looking to do that, we recommend getting in touch with us via [support@121.global](mailto:support@121.global).
...
- **Select the column(s)** in the dropdown list;
