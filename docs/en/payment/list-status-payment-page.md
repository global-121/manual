---
title: Payments - Payment Messages and Status in 121
hide:
  - toc
---
...
| :---- | :----------- | :---------- |
| **Registered** | The registrations have been registered into the program and is not yet included. | A CVA Manager or Officer can validate them; only a CVA Manager can include them in the program. |
| **Validated** | The registrations details have been verified. Registration was validated by a CVA Manager or Officer. They are not yet included in the program and cannot receive payments. | A CVA Manager can include the registrations in the program, or a CVA Manager or Officer can decline them. |
| **Included** | The registrations were included in the program and can start receiving payment transfers via the 121 portal. | A CVA Manager or Finance Manager can select the registrations in the next payment rounds. |
...
| **Paused** | The registrations are currently not being included in the distribution (payments are paused) but still part of the program. | The registrations can be included or declined in the program depending on the SOPs. A CVA Manager or Officer can decide on the status update. |
