---
title: Payments - Manual payment reconciliation
hide:
  - toc
---
In the 121 platform, payments can be processed in two different methods: with a **manual payment via an FSP portal** or with **an FSP configuration**. Below, you will find the step-by-step instructions to import the **manual reconciliation data** into the program, once you have received the payment instructions back from the FSP.
