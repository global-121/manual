...
The format to include a snippet is: (It's a pair of scissors on a line!)

```markdown
## Example snippet

In any Markdown-file you can include a commonly used snippet of text.

\-8<- "docs/en/_snippets/<filename-of-snippet>.md"

```

Found in a hidden page that I now deleted: <!-- markdownlint-disable-next-line no-inline-html -->
