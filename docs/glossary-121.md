...
| **Budget** | Amount of money in the proprogramject that will be disbursed to included people/households. |
...
| **Roles** | Each user will be assigned a position for a specific program (e.g. CVA officer, volunteer, Financial officer etc.). This is done in the "Team" page of the program details. Each role has 1 or more permissions. |
...
| Term | Definition |
| :------------------ | :------------------------------------------------------------------- |
| **Program details** | In this page users can fill in the information of the program like it's name, amount of registrations the program wishes to reach etc. |
