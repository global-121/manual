...
| **Actions**            | Where a user can do something that affects one or multiple registrations, e.g. sending a message, adding a note, or updating the information.|
| **Filter by**          | A place for users to extract registrations to find a group of registrations or a single registration that they are looking to perform an action on e.g. filter registrations that received 2 payment and include in a new payment.|
| **Quick search**       | A filter search that shows results of multiple columns instead of filtering by 1 column. This is a fast way to find a single or small group of registrations.|
...
| **Payment or payments** | A collection of transfers to one or multiple registrations. |
| **Transfer** | A single transfer of money to a person/household. A person/household will receive the number of transfers pre-decided in the project. Depending on the project, if registered late, the first transfer of the person/household might be part of the third payment of a project.|
...
| **Registrations** | The page within a project where all people or households who have registered are listed in a table. Each "Registration" represents the data submitted by individuals or households to enroll in the project. Users can perform various actions on these registrations, such as selecting them to include in the project.|
...
| Term                   | Definition                           |
| :------------------    | :------------------------------------------------------------------- |
| **Registrations target** | The amount of people/households that a project wishes to help.|
| **Registrations reached** | The amount of people/households that have been receiving funds through a project.|
| **Budget** | The amount of funds allocated for disbursement in a project.|
...
| Term                   | Definition                           |
| :------------------    | :------------------------------------------------------------------- |
| **Project details** | In this page users can fill in the information of the project like it's name, amount of people/ households the project wishes to reach etc. |
| **Project title** | Where the users can rename the project.|
| **Data mapping** | Sync kobo/csv file into the data table you'll be running the project on.|
...
| **Verified** | Person/ head of household's identity was confirmed by a 121 user.|
| **Included** | Person/ head of household's identity was confirmed by a 121 user.|
| **Declined** | Person/ household was found to be incorrectly registered (duplication, low inclusion score etc.) and will not be included in the project.|
| **Completed** | Person/household received the full amount of transfers.|
| **Deleted**| Registration has been deleted, their personal details were deleted - only some details are still available for reporting.|
| **Paused** | Registration currently not being included in the payments but is still part of the project.|

### Payments

| Term                   | Definition                           |
| :------------------    | :------------------------------------------------------------------- |
| **Payment or transactions** | A collection of transfers to one or multiple households or People Affected.|
| **Transfer value** | The amount of money a registration is meant to recieve in single a payment.|
...
| Term                | Definition                           |
| :------------------    | :------------------------------------------------------------------- |
| **Pending** | The transfer is being sent to the registration. The status might remain "pending" if the person or household has not received the transfer yet, or may have received the transfer but the data in 121 is not yet reconciled.|
| **Successful** | The transfer arrived to the person/household and they can now use it.|
| **Failed** | The transfer did not arrive to the person/ household. This could happen for a variety of reasons.|
...
| **Card number** | In some projects the amount of money a person/ household can spend in a single month is capped. This is a precaution measure to avoid missuse of the cards and is a KYC requirement. |
